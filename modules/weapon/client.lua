...
anims[`GROUP_SMG`] = { 'reaction@intimidation@1h', 'intro', 400, 'reaction@intimidation@1h', 'outro', 450 }
...
function Weapon.Equip(item, data, noWeaponAnim)
	...
	if item.group == `GROUP_PETROLCAN` or item.group == `GROUP_FIREEXTINGUISHER` or item.hash == `WEAPON_FLAMETHROWER` then
